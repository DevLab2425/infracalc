...
window.InfraCalc = window.InfraCalc || {
    ...
    init: () => {
        ...
        const { setupSelectors, setupToggleButtons, setupFormHandlers, } = window.InfraCalc;
        setupSelectors();
        setupToggleButtons();
        setupFormHandlers();
    },
    ...
    setupFormHandlers: () => {
        ...
        const productForm = document.getElementById('prod-rate-form');
        const buildForm = document.getElementById('build-calc-form');
    ...
    toggleMode: (ev) => {
        ...
        const activeRadioWrapper = document.getElementById(`${value}-calculation`);
...
//# sourceMappingURL=infra-calc-scripts.js.map